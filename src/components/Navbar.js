        ...
        <header className="z-50 text-gray-400 bg-black shadow-2xl w-full body-font fixed px-5 md:px-0">
            <div className="w-full mx-auto flex flex-wrap px-1 md:px-0 py-2 justify-between items-center">
                ...
                <nav className="mx-auto lg:mr-14 flex flex-wrap items-center text-base justify-center">
                    ...
                    <button className=" mx-5 md:ml-5 rounded-full inline-flex text-black bg-cyan-500 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg my-2"><a href='https://drive.google.com/file/d/1zAqT6Kah430FtGJF9HVfUBLEdHG9um5H/view?usp=drive_link'>Resume</a></button>
