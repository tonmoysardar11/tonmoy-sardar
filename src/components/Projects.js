    ...
    return (
        ...
        >
            ...
            <h1 className="title-font sm:text-4xl text-3xl mx-20 mb-4 font-medium text-white">PROJECTS
                ...
                <Zoom>
                <section className="text-gray-400 body-font animate__animated animate__backInUp">
                    <div className="container mx-auto flex py-20 md:flex-row flex-col items-center">
                        <div className=" mx-20 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <div className="flex justify-center">
                                <button className=" rounded-full inline-flex text-black bg-cyan-300 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-200 rounded text-lg"><a href='http://medhavardhan.org/'>Live Website</a></button>
                ...
                <section className="text-gray-400 body-font animate__animated animate__backInUp">
                    <div className="container mx-auto flex py-20 md:flex-row flex-col items-center">
                        <div className=" mx-20 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <div className="flex justify-center">
                                <button className=" rounded-full inline-flex text-black bg-cyan-300 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-200 rounded text-lg"><a href='https://tonmoysardar11.github.io/Panda-Jump-game/'>Live Website</a></button>
                    ...
                    <div className="container mx-auto flex py-20 md:flex-row flex-col items-center">
                        <div className=" mx-20 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <div className="flex justify-center">
                                ...
                                <button className=" rounded-full ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-cyan-200 hover:text-white rounded text-lg"><a href='https://github.com/tonmoysardar11/Advanced-Todo'>View Code</a></button>
                            </div>
                        </div>
                        <div className="mx-20 lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
