...
import pj from './media/pj.png'
import cwh from './media/cwh.png'
                    ...
                    <div className="container mx-auto flex py-20 md:flex-row flex-col items-center">
                        <div className=" mx-20 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <div className="flex justify-center">
                                <button className=" rounded-full inline-flex text-black bg-cyan-300 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg"><a href='http://medhavardhan.org/'>Live Website</a></button>
                                <button className=" rounded-full ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg"><a href='https://github.com/tonmoysardar11/Medhavardhan'>View Code</a></button>
                            </div>
                        </div>
                        <div className="mx-20 lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                            <img className="object-cover object-center rounded" alt="hero" src={mf} />
                        </div>
                    </div>
                </section>
                </Bounce>
                ...
                <section className="text-gray-400 body-font animate__animated animate__bounceInUp">
                    <div className="container mx-auto flex py-20 md:flex-row flex-col items-center">
                        <div className=" mx-20 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <div className="flex justify-center">
                                <button className=" rounded-full inline-flex text-black bg-cyan-300 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg"><a href='https://tonmoysardar11.github.io/Panda-Jump-game/'>Live Website</a></button>
                                <button className=" rounded-full ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg"><a href='https://github.com/tonmoysardar11/Panda-Jump-game'>View Code</a></button>
                            </div>
                        </div>
                        <div className="mx-20 lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                            <img className="object-cover object-center rounded" alt="hero" src={pj} />
                        </div>
                    </div>
                </section>
                </Bounce>
                ...
                <section className="text-gray-400 body-font animate__animated animate__bounceInUp">
                    <div className="container mx-auto flex py-20 md:flex-row flex-col items-center">
                        <div className=" mx-20 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <div className="flex justify-center">
                                <button className=" rounded-full inline-flex text-black bg-cyan-300 border-0 py-2 px-6 focus:outline-none hover:bg-blue-600 rounded text-lg"><a href='https://tonmoysardar11.github.io/clone_codewithharry/'>Live Website</a></button>
                                <button className=" rounded-full ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg"><a href='https://github.com/tonmoysardar11/clone_codewithharry'>View Code</a></button>
                            </div>
                        </div>
                        <div className="mx-20 lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                            <img className="object-cover object-center rounded" alt="hero" src={cwh} />
                        </div>
                    </div>
                </section>
                </Bounce>
                    ...
                    <div className="container mx-auto flex py-20 md:flex-row flex-col items-center">
                        <div className=" mx-20 lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
                            ...
                            <div className="flex justify-center">
                                ...
                                <button className=" rounded-full ml-4 inline-flex text-gray-400 bg-gray-800 border-0 py-2 px-6 focus:outline-none hover:bg-gray-700 hover:text-white rounded text-lg"><a href='https://github.com/tonmoysardar11/Advanced-Todo'>View Code</a></button>
                            </div>
                        </div>
                        <div className="mx-20 lg:max-w-lg lg:w-full md:w-1/2 w-5/6">
                            <img className="object-cover object-center rounded" alt="hero" src={at} />
                        </div>
                    </div>
                </section>
                </Bounce>
