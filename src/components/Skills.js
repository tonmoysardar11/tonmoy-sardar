...
import redux from './media/redux.webp'
import tail from './media/tailwind.webp'
            ...
            <section className="text-gray-400 body-font bg-transparent py-20" id='skills'>
                <div className="container py-24 mx-auto">
                    ...
                    <div className="flex flex-wrap items-center justify-center -m-4 mx-auto">
                        <Flip>
                        <div className="w-25 h-25 mx-5 my-5 rounded-full inline-flex items-center justify-center bg-gray-100 text-gray-600 animate__animated animate__flipInX animate__slow overflow-hidden">
                        ...
                        <Flip>
                        <div className="w-25 h-25 mx-5 my-5 rounded-full inline-flex items-center justify-center bg-gray-100 text-gray-600 animate__animated animate__flipInX animate__slow overflow-hidden">
                            <img src={tail} alt=""  width={100} height={100}/>
                        </div>
                        </Flip>
                    </div>
                </div>
